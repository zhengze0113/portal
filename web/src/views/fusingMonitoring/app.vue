...
export default {
  ...
  methods: {
    ...
    async rowClick(row, column, event) {
      ...
      this.monitoringFrom.degradeCpu = row.cpu;
      this.monitoringFrom.degradeMemory = row.gb;

      this.monitoringFrom.turbineCpu = row.cpu;
      this.monitoringFrom.turbineMemory = row.gb;
      if (
    ...
    async fetchData() {
      ...
      this.monitoringFrom.degradeCpu = this.skulist[0].cpu;
      this.monitoringFrom.degradeMemory = this.skulist[0].gb;

      this.monitoringFrom.turbineCpu = this.skulist[0].cpu;
      this.monitoringFrom.turbineMemory = this.skulist[0].gb;
    },
    //获取集群
    async getClusters() {
      this.edit = [];
