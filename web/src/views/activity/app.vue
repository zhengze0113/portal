  ...
  <div id="app">
    <el-carousel :height="screenHeight + 'px'" style="position: relative;">
      <el-carousel-item
        ...
        :key="index"
        :style="{
          backgroundImage: 'url(' + baseURL.DATAURL + pic.cover.url + ')'
        }"
      >
        <el-row>
          <el-col
...
export default {
  ...
  methods: {
    linkBuy() {
      window.location.href = "/html/productDetail1.html?id=15";
    },
    async getType() {
